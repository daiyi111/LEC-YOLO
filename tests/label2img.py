...
def draw_box_in_single_image(image_path, txt_path):
    ...
    if pos:
        cv2.imwrite('./see_images/{}.png'.format(image_path.split('\\')[-1][:-4]), image)
    else:
        print('None')
...
img_folder = "../datasets/AI-TOD/val/images"
img_list = os.listdir(img_folder)
img_list.sort()

label_folder = "../datasets/AI-TOD/val/labels"
...
if __name__ == '__main__':
    draw_box_in_single_image(image_path=r"E:\daiyi\python\yolov13-main\yolov13-main\datasets\AI-TOD\test\images\P0111__1.0__600___600.png",txt_path=r"E:\daiyi\python\yolov13-main\yolov13-main\datasets\AI-TOD\test\labels\P0111__1.0__600___600.txt")
