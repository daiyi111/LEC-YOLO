...
def main():
    ...
    parser.add_argument("--dataset_path", type=str, default=r"E:\daiyi\python\ultralytics\ultralytics\datasets\visdrone\VisDrone2019-DET-train", help="YOLO数据集的根目录")
    parser.add_argument("--output", type=str, default=r"E:\daiyi\python\ultralytics\ultralytics\datasets\visdrone\VisDrone2019-DET-train\visdrone-train.json", help="输出的COCO格式JSON文件路径")
